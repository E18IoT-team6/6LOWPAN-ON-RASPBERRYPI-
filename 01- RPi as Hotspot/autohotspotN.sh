...
#
#  Program name      : autohotspotN.sh
#
#  Description       : Script to switch between a router-wifi network and an 
#                      Internet routed Hotspot
#
#  Modified by       : Carlos Hansen and Mustafa Khaan Claasz Coockson
#
#  Original version  : http://www.raspberryconnect.com
#
# **********************************************************************
...
ssids=('dlink-675C' 'mySSID1' 'mySSID2' 'mySSID3')
